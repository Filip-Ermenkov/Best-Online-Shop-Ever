  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8">
        ...
        {/* Returns */}
        <section>
          <h2 className="text-xl font-semibold mb-4 flex items-center gap-2"><RotateCcw className="w-5 h-5 text-primary" /> Право на връщане</h2>
          <div className="rounded-lg border border-border bg-card p-5 space-y-3 text-sm text-muted-foreground leading-relaxed">
            <p>Имате право да върнете закупен продукт в рамките на <strong className="text-foreground">14 дни</strong> от получаването му без да посочвате причина.</p>
            <p>Продуктът трябва да бъде в оригиналната си опаковка, неизползван и без следи от употреба. Разходите за обратна доставка са за сметка на клиента.</p>
            <p>Сумата се възстановява по оригиналния начин на плащане в рамките на <strong className="text-foreground">5–10 работни дни</strong> след получаване и проверка на върнатия продукт.</p>
          </div>
        </section>
